...
typealias BannerItemHandler = (AKBannerItem, Int)->Void


private let cellIdentifier = "BannerView.BannerCollectionCell"


class AKBannerDataSource: NSObject,UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout  {
    
    private (set) weak var bannerView: AKBannerView!
    private (set) var bannerItems: [AKBannerItem]?
    ...
    private weak var collectionView: UICollectionView? {
        didSet {
            collectionView?.register(
                AKBannerCollectionCell.self,
                forCellWithReuseIdentifier: cellIdentifier
            )
        }
    }
    private var bannerCollectionView: AKBannerCollectionView? {
        return collectionView as? AKBannerCollectionView
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: AKBannerCollectionCell = {
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: cellIdentifier,
                for: indexPath
                ) as? AKBannerCollectionCell else {
                    return AKBannerCollectionCell()
            }
            return cell
        }()
